...
<head>
    ...
    <style>
        ...
        .card-register { background:white; border-radius:25px; padding:30px; width:320px; box-shadow:0 10px 25px rgba(0,0,0,.2); }
...
<div class="bg-wave">
    <div class="card-register">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button class="btn btn-red mt-2">Cadastrar</button>
        </form>
